...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Your Companies Blog Creator</h1>
            <hr/>
        ...
        <header class="head-section">
            <div class="navbar navbar-default navbar-static-top container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">Womens<span>Warehouse</span></a>
                </div>
                <div class="navbar-collapse collapse">
                    <ul id="navbar" class="nav navbar-nav">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/tinymce_prototype">tinyMCE</a>
                        </li>
                        <li>
                            <a herf="${pageContext.request.contextPath}/tinymce_prototype">tinyMCE2</a>
                        </li>
                    </ul>
                </div>
            </div>
