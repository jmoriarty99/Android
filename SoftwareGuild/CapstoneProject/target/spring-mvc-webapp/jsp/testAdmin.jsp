    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <form id="create-blog" class="form-horizontal">
                    <div class ="form-group">
                        <textarea id="mytextarea"></textarea>
                        <input id="blog-submit" type="submit" class="btn btn-default" value="Post"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="category" class="form-control" id="add-category" placeholder="Category">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="add-post-date" class="col-md-4 control-label">Post Date</label>
                        <div class="col-md-8">
                            <input type="text" name="date" class="form-control" id="add-post-date" placeholder="Date">
                        </div>
                    </div>
                    ...
                    <input type="submit" class="btn btn-default pull-right" value="Create Blog" />
